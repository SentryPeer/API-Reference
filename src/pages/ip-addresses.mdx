export const description =
    'On this page, we’ll dive into the IP address endpoint to check if a phone number has been seen by the SentryPeer honeypots.'
...
## Query a phone number {{ tag: 'GET', label: '/api/ip-addresses/:ip-address' }}
