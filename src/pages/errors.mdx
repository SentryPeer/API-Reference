...
<Note>
  ...
  your code before contacting SentryPeer support.
</Note>
...
<Row>
  <Col>
    ...
    Here is a list of the two error types supported by the SentryPeer API — use these to understand what you have done wrong.
